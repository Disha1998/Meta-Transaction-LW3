...
contract TokenSender {
    ...
    function transfer(
        ...
        // convert it to sign message hash
        bytes32 signedMessageHash = messageHash.toEthSignedMessageHash();

        // Require that this signature hasn't already been executed
        require(!executed[signedMessageHash], "already eecuted....!");
        ...
        // Mark this signature has having been executed now
